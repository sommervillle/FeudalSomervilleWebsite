...
/*
  ...
  Timing (2.5s total):
    0.0s          mount: backdrop opaque, monogram at opacity 0
                  and translateY 20px
    0.0 -> 1.5s   monogram rises 20px and fades in to opacity 1
    1.5 -> 2.0s   hold (0.5s — fade-in eats most of the pre-exit
                  window; the brief settle still reads as a beat)
