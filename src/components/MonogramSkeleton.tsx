...
/*
  ...
  Visual:
    ...
    - Subtle pulse: opacity oscillates 0.02 -> 0.25 -> 0.02 on a
      3s easeInOut loop, repeating. Floor at 0.02 keeps the
      monogram always faintly visible — it never goes fully
      invisible. Reduced-motion users get a static 0.13 (the
      animation midpoint).
  ...
  return (
    ...
    >
      <motion.img
        ...
        animate={reduceMotion ? { opacity: STATIC_OPACITY } : { opacity: [0.02, 0.25, 0.02] }}
        transition={
          reduceMotion
            ? { duration: 0 }
            : {
